...
class Circfilter(object):
    def __init__(self,length,countthreshold,replicatethreshold):
        '''
    ...
    def removeChrM(self, withChrM):
        ...
        removedfile = open('_tmp_DCC/tmp_unsortedNoChrM','w')
    ...
    def remove_tmp(self):
        try:
            os.remove('_tmp_DCC/tmp_left')
            os.remove('_tmp_DCC/tmp_right') 
            os.remove('_tmp_DCC/tmp_unsortedWithChrM')
            os.remove('_tmp_DCC/tmp_unsortedNoChrM') 
            #os.remove('tmpSorted')
        except OSError:
            pass
