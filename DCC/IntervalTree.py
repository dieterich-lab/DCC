...
class IntervalTree( object ):
    ...
    def insert( self, interval, annotation=None ):
        ...
        if interval.chrom in self.chroms:
            self.chroms[chrom] = self.chroms[chrom].insert( start, end, strand, annotation )  # self.chroms[chrom] is a IntervalNode object
        else:
    ...
    def intersect( self, interval, report_func ):
        ...
        if chrom in self.chroms:
            self.chroms[chrom].intersect( start, end, strand, report_func )  # use the intersect method of IntervalNode class, need make this function aware of strand
